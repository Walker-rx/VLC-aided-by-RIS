...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% yz opposite %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                if (angle_RIS_yz_opposite(1) > 0) && (angle_RIS_yz_opposite(1) < pi) && (angle_RIS_yz_opposite(2) > pi/2) && (angle_RIS_yz_opposite(2) < 3*pi/2)
                    ...
                    if all(abs(coor_reflect_yz_opposite-coor_RIS_yz_opposite)<1e-7)
                        if (~judge_intersect(coor_led,coor_reflect_yz_opposite,coor_obstacle,angle_obstacle,obstacle_length)) && (~judge_intersect(coor_reflect_yz_opposite,coor_PD,coor_obstacle,angle_obstacle,obstacle_length))
